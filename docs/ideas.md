...
- [ ] DeepSeek API extracts structured data from articles
...
- [ ] Each card shows a title in 20 words that helps the viewer identify the breach
- [ ] Filter by tags (continent, country, industry, attack vector, threat actor)
- [ ] Search by keyword functionality (help user find a breach in their mind) 
...
- [ ] Robust error handling for DeepSeek API failures
